...
export const actions = {
    ...
    async actionGetStocks(context: MainContext) {
        try {
            const response = await api.getStocks(context.state.token);
            if (response.data) {
    ...
    async actionGetPortfolio(context: MainContext) {
        try {
            const response = await api.getPortfolio(context.state.token);
            if (response.data) {
                console.log(response.data);
    ...
    async actionAddToPortfolio(context: MainContext, payload) {
        try {
            const response = await api.addToPortfolio(context.state.token, payload);
            if (response.data) {
                console.log(response.data);
    ...
    async actionRemoveFromPortfolio(context: MainContext, payload) {
        try {
            const response = await api.removeFromPortfolio(context.state.token, payload);
            if (response.data) {
                console.log(response.data);
                commitAddNotification(context, {content: 'Portfolio successfully updated!', color: 'success'});
            }
...
export const dispatchRemoveFromPortfolio = dispatch(actions.actionRemoveFromPortfolio);
